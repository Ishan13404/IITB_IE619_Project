...
pygame.display.set_caption("CARDISCO 2")
...
def Draw_Game_Board(Gameboard, Available_options, Player_Pointer, Player_to_Move, Last_Picked_Card):
    TextOnScreen("*** CARDISCO 2 ***", (128,204,199), Screen_Width*0.4, Screen_Height*0.1-50)
...
def Homescreen():
    while(True):
        gameWindow.fill(white)
        TextOnScreen("Welcome to CARDISCO 2", green, Screen_Width*0.4, Screen_Height/2-25)
